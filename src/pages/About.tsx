...
const About = () => {
  useSEO({
    title: "About MyRecruita | Expert Finance, Tech & Legal Recruiters UK",
    description: "Learn about MyRecruita's mission to connect skilled professionals with high-impact roles in Finance, IT, and Law. Expert recruitment team based in London.",
    canonical: `${window.location.origin}/about`,
    keywords: ["about myrecruita", "recruitment agency london", "finance recruiters uk", "tech recruitment", "legal recruitment", "recruitment experts"],
    schema: {
      "@type": "AboutPage",
      "mainEntity": {
        "@type": "Organization",
        "name": "MyRecruita",
        "description": "Expert recruitment agency specializing in Finance, Technology, and Legal sectors"
      }
    }
  });
  ...
  return (
    <>
      ...
      <StructuredData data={businessSchema} id="local-business" />
      <SEOBreadcrumb />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="text-center mb-20 animate-fade-in">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent mb-8">
                About MyRecruita: Recruitment Reimagined
              </h1>
            ...
            <InternalLinking currentPage="/about" className="mt-20" />
          </div>
        </div>
      </div>
    </>
