...
const Contact = () => {
  ...
  useSEO({
    title: "Contact MyRecruita | Get Expert Recruitment Support & Advice",
    description: "Contact MyRecruita for expert recruitment support, career guidance, and talent acquisition. Based in London with UK-wide services. Response within 2 hours.",
    canonical: `${window.location.origin}/contact`,
    keywords: ["contact myrecruita", "recruitment support london", "career advice", "hiring help", "recruitment agency contact"],
    schema: {
      "@type": "ContactPage",
      "mainEntity": {
        "@type": "Organization",
    ...
    <>
      ...
      <div className="min-h-screen bg-background py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FAQSection faqs={recruitmentFAQs} className="mt-12" />
          <InternalLinking currentPage="/contact" className="mt-12" />
        </div>
      </div>
    </>
  );
